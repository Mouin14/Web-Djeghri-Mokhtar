...
export default function App() {
    ...
    return (
        <div
            className={`min-h-screen ${isRtl ? "font-arabic" : "font-sans"} ${darkMode ? "dark" : ""} bg-background text-foreground transition-colors duration-300`}
        >
            {/* Government Banner */}
            ...
            {/* Navbar */}
            <nav
                className={`sticky top-0 z-50 transition-all duration-500 ${scrolled ? "glass shadow-lg py-2" : "bg-transparent py-4"
                    }`}
            >
                    ...
                    <div className="flex items-center justify-between h-16 lg:h-20">
                        ...
                        <div className="flex items-center gap-2 sm:gap-3">
                            ...
                            <div className={`${isRtl ? "text-right" : "text-left"}`}>
                                <div className="font-bold text-xs sm:text-sm text-foreground leading-tight truncate max-w-[120px] sm:max-w-none">
                                    {t.hospitalName}
                                </div>
                                <div className="text-[10px] sm:text-xs text-muted-foreground hidden xs:block">
                                    {t.hospitalSubname}
                                </div>
                            </div>
                        </div>
            ...
            <section
                id="hero"
                className="relative min-h-[85vh] sm:min-h-[90vh] overflow-hidden"
            >
                {/* Background Image */}
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-24">
                    <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center min-h-[65vh] sm:min-h-[70vh]">
                        ...
                        <div className={`text-white ${isRtl ? "text-right" : "text-left"}`}>
                            {/* Official Badge */}
                            <div
                                className={`inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 bg-white/10 backdrop-blur-sm rounded-full border border-white/20 mb-6 sm:mb-8 ${isRtl ? "flex-row-reverse" : ""}`}
                            >
                                <span className="text-[#006233] text-base sm:text-lg">
                                    &#9770;
                                </span>
                            ...
                            <div
                                className={`flex flex-col sm:flex-row gap-3 sm:gap-4 mb-8 sm:mb-10 ${isRtl ? "sm:justify-end" : "sm:justify-start"}`}
                            >
                                <Button
                                    size="lg"
                            ...
                            <div
                                className={`grid grid-cols-1 sm:flex sm:flex-wrap gap-3 sm:gap-4 ${isRtl ? "sm:justify-end" : "sm:justify-start"}`}
                            >
                                {[
                        ...
                        {[
                            ...
                            >
                                <div className="flex items-center sm:items-start gap-3 sm:gap-0 sm:flex-col">
                                    <div
                                        className={`w-10 h-10 sm:w-12 sm:h-12 rounded-lg sm:rounded-xl flex items-center justify-center transition-transform group-hover:scale-110 shrink-0 sm:mb-4 ${stat.bgClass}`}
                                    >
                                        <stat.icon
                                            className={`w-5 h-5 sm:w-6 sm:h-6 ${stat.colorClass}`}
                                        />
                                    </div>
                                    <div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                        {[
                            ...
                            <div
                                key={i}
                                className="group bg-card rounded-2xl p-6 shadow-md hover:shadow-xl transition-all duration-300 border border-transparent hover:border-secondary/30"
                            >
                                <div
                                    className={`w-14 h-14 rounded-xl flex items-center justify-center mb-4 transition-transform group-hover:scale-110 ${service.bgClass}`}
                                >
                                    <service.icon
                                        className={`w-7 h-7 ${service.colorClass}`}
                                    />
                                </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div className="md:col-span-2 md:row-span-2 group relative min-h-[400px] rounded-2xl overflow-hidden shadow-xl">
                            ...
                            <div className="absolute bottom-0 left-0 right-0 p-8 text-white">
                                <span className="px-4 py-1.5 bg-secondary rounded-full text-xs font-medium mb-4 inline-block shadow-sm">
                                    {t.photo1Badge}
                                </span>
                        ...
                        <div className="relative">
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div className="space-y-4 pt-8">
                                    ...
                                    <div className="rounded-2xl overflow-hidden shadow-lg h-48">
                                        <img
                                            src="https://images.unsplash.com/photo-1530497610245-94d3c16cda28?w=400&h=300&fit=crop"
                                            alt="Equipment"
                                            className="w-full h-full object-cover"
                                        />
                                    </div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-8">
                                ...
                                >
                                    ...
                                    <div>
                                        ...
                                        <div className="font-semibold text-foreground flex items-center gap-2">
                                            {item.value}
                                            {item.badge && (
                                                <span className="px-2 py-0.5 bg-destructive text-white text-[10px] rounded-full">
                                                    24/7
                                                </span>
                                            )}
                                        </div>
                        ...
                        >
                            ...
                            <div className="absolute inset-0 flex flex-col items-center justify-end p-6 text-center z-20 pb-8">
                                ...
                                <h3 className="text-xl font-bold text-foreground mb-1 group-hover:text-[#2196A6] transition-colors">
                                    {t.hospitalName}
                                </h3>
            ...
            <footer className="bg-[#1E3A5F] dark:bg-[#06090e] text-white py-16 border-t border-white/5">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="flex gap-6">
                            {navLinks.map((link) => (
                                <button
                                    key={link.id}
                                    onClick={() => scrollToSection(link.id)}
                                    className="text-sm font-medium hover:text-secondary-foreground transition-colors"
                                >
                                    {link.label}
                                </button>
                            ))}
                    ...
                    <div className="text-center text-white/60 text-sm max-w-xl mx-auto leading-relaxed">
                        <p className="mb-2">
                            Under the supervision of the Ministry of Health — Algeria
                        </p>
                        <p>
                            &copy; {new Date().getFullYear()} {t.hospitalName}. {t.copyright}
                        </p>
                    </div>
                </div>
            </footer>
            ...
            <div
                className={`fixed bottom-8 ${isRtl ? "left-8" : "right-8"} z-[60] flex flex-col items-center gap-2 group`}
            >
            ...
            <div className="fixed top-0 left-0 w-full h-1 z-[100] pointer-events-none">
                <div
                    ...
                    style={{
                        width: `${Math.min((statsVisible ? 100 : 0) + (scrolled ? 30 : 0), 100)}%`,
