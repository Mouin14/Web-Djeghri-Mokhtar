...
import { User, Mail, ShieldCheck, Lock, Save, Phone } from 'lucide-react';
...
const AdminProfile = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.put('/api/admin/profile', dataToSend);
        ...
        <div className="space-y-10">
            ...
            <div className="glass-morphism-premium rounded-[2.5rem] p-8 md:p-10 border border-white/40 dark:border-white/5 relative overflow-hidden group">
                ...
                <div className="relative z-10 flex items-center gap-6">
                    ...
                    <div>
                        <h1 className="text-4xl font-black text-slate-900 dark:text-white mb-2 tracking-tight">Profil Administrateur</h1>
                        <p className="text-sm font-medium text-slate-500 dark:text-gray-300">Gérez vos informations de compte système</p>
                    </div>
                </div>
            </div>
                ...
                <div className="lg:col-span-4">
                    <div className="glass-morphism-premium rounded-[2.5rem] p-10 border border-white/40 dark:border-white/5 shadow-2xl">
                        <div className="flex flex-col items-center mb-10">
                            <div className="w-28 h-28 bg-gradient-to-br from-blue-600 to-indigo-700 rounded-[2.5rem] flex items-center justify-center text-white text-4xl font-black shadow-2xl mb-6 transform rotate-3 hover:rotate-0 transition-transform duration-500">
                                {profile?.prenom?.charAt(0)}{profile?.nom?.charAt(0)}
                            </div>
                            <h2 className="text-2xl font-black text-slate-900 dark:text-white mb-2">
                                {profile?.prenom} {profile?.nom}
                            </h2>
                            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-blue-600/10 border border-blue-600/20 text-blue-600 dark:text-blue-400 text-[10px] font-black uppercase tracking-[0.2em]">
                                <ShieldCheck className="w-3 h-3" /> Administrateur Système
                            </div>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-10">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="relative group">
                                        ...
                                        <input
                                            ...
                                            required
                                            className="w-full pl-14 pr-6 py-4 bg-white/50 dark:bg-white/5 border border-white/40 dark:border-white/10 rounded-2xl focus:ring-4 focus:ring-blue-600/10 outline-none transition-all dark:text-white font-bold"
                                        />
                                    </div>
                                </div>
                                <div className="space-y-2">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                        <div className="space-y-2">
                                            ...
                                            <input
                                                ...
                                                minLength={8}
                                                className="w-full px-6 py-4 bg-white/50 dark:bg-white/5 border border-white/40 dark:border-white/10 rounded-2xl focus:ring-4 focus:ring-blue-600/10 outline-none transition-all dark:text-white font-bold"
                                                placeholder="••••••••"
                                            />
                                        </div>
                                        <div className="space-y-2">
                            ...
                            <div className="flex justify-end pt-6">
                                <button
                                    ...
                                    className="group bg-blue-600 hover:bg-blue-700 text-white px-10 py-5 rounded-2xl font-black uppercase tracking-widest text-xs transition-all shadow-2xl shadow-blue-500/30 active:scale-95 flex items-center gap-3 disabled:opacity-50"
                                >
